    ...
    <div>
      ...
      <div className={classes.aboutWrap}>
        ...
        <div className={classes.paraWrap}>
          ...
          <p>
            <strong>사용자 중심</strong>으로 누구나 <strong>접근이 쉽고 편리한</strong> 웹 페이지를
            제작해 나가는 웹개발자
          </p>
          <p>
            할당된 임무를 꼼꼼히 완수해 나갈 수 있는 <strong>섬세한 성격</strong>
          </p>
          <p>
            원하는 결과를 얻기위해 <strong>끊임없이 고민하고 시도</strong>할 수 있는 능력
          </p>
          <p>
            <strong>
